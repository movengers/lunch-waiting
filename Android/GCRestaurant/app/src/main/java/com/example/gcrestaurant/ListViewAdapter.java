...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        itemNameTextView.setText(listViewItem.getItemName());
        itemPriceTextView.setText(listViewItem.getItemPrice());
    ...
    public void addItem(Drawable icon, int no, String name, String price) {
